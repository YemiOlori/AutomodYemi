...
from . import moderation_tools as mod_tools
...
guest_list = mod_tools.guest_list
mod_list = mod_tools.mod_list
approved_ping_list = mod_tools.approved_ping_list
set_interval = mod_tools.set_interval
